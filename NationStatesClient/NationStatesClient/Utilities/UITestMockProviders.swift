...
struct UITestMockProviders {
    ...
    static var resolutionProvider: ResolutionProvider {
        ...
        return MockedResolutionProvider(generalAssemblyResolution: .init(category: "Civil Rights", created: Date(), id: "0", name: "Right To Secure Digital Communication", option: "", promoted: Date(), proposedBy: "elest_adra", totalNationsAgainst: 815, totalNationsFor: 4252, totalVotesAgainst: 2054, totalVotesFor: 10621, information: .init(localId: "localId", textHTML: htmlText)), delay: 0)
    }
